...
namespace SuiBot_TwitchSocket.Interfaces
{
	public interface IBotInstance: IDisposable
	{
		...
		void TwitchSocket_SharedChatBegin(ES_SharedChatEnd obj);
		void TwitchSocket_SharedChatUpdate(ES_SharedChatUpdate obj);
		void TwitchSocket_SharedChatEnd(ES_SharedChatBegin obj);
	}
